...
class VehiclesCounting():
    def __init__(self, file_counter_log_name, framework='tf', weights='./checkpoints/yolov4-416',
                size=416, tiny=True, model='yolov4', video='./data/videos/test-shoes-15-23-40.mp4',
                output='./outputs/test.avi', output_format='XVID', iou=0.45, score=0.5,
