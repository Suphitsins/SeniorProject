...
class VehiclesCounting():
    def __init__(self, file_counter_log_name, framework='tf', weights='./checkpoints/yolov4-416',
                size=416, tiny=True, model='yolov4', video='./data/videos/test-shoes.mp4',
                output='./outputs/countline11.avi', output_format='XVID', iou=0.45, score=0.5,
                dont_show=True, info=True,
